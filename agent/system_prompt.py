...
from agent.supervisor_contract import SUPERVISOR_DEVELOPER_INSTRUCTIONS


SUPERVISOR_CONTROL_TOWER_GUIDANCE = (
    "<hermes-supervisor-contract>\n"
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    if getattr(agent, "_supervisor_mode", False):
        stable_parts.append(SUPERVISOR_CONTROL_TOWER_GUIDANCE)
