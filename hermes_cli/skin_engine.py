...
[dim #7A3511]⠀⠀⠀⠀⠀⠀⠀tail flame lit⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "claude": {
        "name": "claude",
        "description": "Claude Code style — muted purple accent on dark",
        "colors": {
            "banner_border": "#7c7597",
            "banner_title": "#d4d4d4",
            "banner_accent": "#7c7597",
            "banner_dim": "#524f67",
            "banner_text": "#d4d4d4",
            "ui_accent": "#8b85a6",
            "ui_label": "#7c7597",
            ...
            "prompt": "#d4d4d4",
            "input_rule": "#524f67",
            "response_border": "#524f67",
            "status_bar_bg": "#1a1a2e",
            "status_bar_text": "#9ca3af",
            "status_bar_strong": "#8b85a6",
            "status_bar_dim": "#3d3a52",
            "status_bar_good": "#3fb950",
            "status_bar_warn": "#d29922",
            "status_bar_bad": "#f85149",
            "status_bar_critical": "#ff6b6b",
            "session_label": "#7c7597",
            "session_border": "#524f67",
            "status_bar_bg": "#1a1a2e",
            "voice_status_bg": "#1a1a2e",
            "selection_bg": "#2d2a45",
            "completion_menu_bg": "#1a1a2e",
            "completion_menu_current_bg": "#2d2a45",
            "completion_menu_meta_bg": "#16162a",
            "completion_menu_meta_current_bg": "#2d2a45",
        },
        "spinner": {
            "waiting_faces": ["(◠)", "(◡)", "(◉)", "(◌)", "(◑)"],
            "thinking_faces": ["(◠)", "(◡)", "(◉)", "(⌁)", "(◌)"],
            "thinking_verbs": [
                ...
                "examining", "evaluating", "considering", "synthesizing",
            ],
            "wings": [],
        },
        "branding": {
