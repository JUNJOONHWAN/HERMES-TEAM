...
from hermes_cli.subcommands.service import build_service_parser
from hermes_cli.supervisor_cli import build_supervisor_parser
...
def cmd_service(args):
    """Hermes-managed application service control."""
    from hermes_cli.application_service_cli import service_command

    return service_command(args)


def cmd_supervisor(args):
    """Lightweight Hermes supervisor control plane."""
    from hermes_cli.supervisor_cli import supervisor_command

    return supervisor_command(args)
...
_BUILTIN_SUBCOMMANDS = frozenset(
    {
        ...
        "computer-use",
        "config", "console", "cron", "service", "supervisor", "curator", "dashboard", "serve", "debug", "doctor",
...
def main():
    ...
    # =========================================================================
    # service command — desired-state application service control
    # =========================================================================
    build_service_parser(subparsers, cmd_service=cmd_service)

    # Lightweight role-shell supervisor registry and deterministic heartbeat.
    build_supervisor_parser(subparsers, cmd_supervisor=cmd_supervisor)
