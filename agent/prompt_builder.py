...
KANBAN_GUIDANCE = (
    ...
    "7. **Missing tools.** Do not install them yourself. Call "
    "`kanban_capability_missing(capability=..., details=..., receipt=...)`; the "
    "kernel creates a Multitool dependency, parks this card, and resumes a fresh "
    "session. Use a capability block only if delegation is impossible.\n"
    "\n"
    "## Orchestrator mode\n"
    "\n"
