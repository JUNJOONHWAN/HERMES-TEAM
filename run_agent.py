...
_EPHEMERAL_SCAFFOLDING_FLAGS = (
    ...
    # Mixed-script final drafts and their private rewrite nudges are transient
    # retry context.  They must never enter SQLite/JSON session history.
    "_response_language_repair_synthetic",
)
...
class AIAgent:
    ...
    def _try_activate_fallback(
        ...
        *,
        ...
        return try_activate_fallback(self, reason, emit_status=emit_status)
